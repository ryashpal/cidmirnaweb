...
urlpatterns = [
    ...
    url(r'^linc2function_data_selection$', linc2functionviews.linc2function_data_selection, name='linc2function_data_selection'),
    url(r'^linc2function_feature_tree$', linc2functionviews.linc2function_feature_tree, name='linc2flinc2function_feature_treeunction'),
