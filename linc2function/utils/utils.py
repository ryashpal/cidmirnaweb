...
def create_tfr_files(all_seq, base_path, input_file):
    ...
    tfrecordsDir = os.path.join(base_path, 'input_tfr_files')
    if not os.path.exists(tfrecordsDir):
        os.makedirs(tfrecordsDir)
    path_tfrecords = os.path.join(tfrecordsDir, input_file+'.tfrecords')
